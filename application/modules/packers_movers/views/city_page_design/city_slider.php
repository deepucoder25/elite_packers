...
<!-- HERO SLIDER SECTION (EXACT SAME DESIGN AS HOMEPAGE slider.php) -->
      ...
      <div class="row g-3 align-items-center justify-content-between">
        ...
        <div class="col-6 col-lg-3">
          <div class="hero-bottom-feat-card d-flex align-items-center gap-3">
            ...
            <div>
              <h6 class="hero-bottom-feat-title mb-0">100% Safe Shifting</h6>
              <small class="hero-bottom-feat-desc">Scratch-free protection in <?= htmlspecialchars($city) ?></small>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-lg-3">
          <div class="hero-bottom-feat-card d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <small class="hero-bottom-feat-desc">Dedicated container trucks for <?= htmlspecialchars($city) ?></small>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-lg-3">
          <div class="hero-bottom-feat-card d-flex align-items-center gap-3">
            ...
            <div>
              <h6 class="hero-bottom-feat-title mb-0">Certified Crew</h6>
              <small class="hero-bottom-feat-desc">Trained in-house packers &amp; carpenters</small>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-lg-3">
          <div class="hero-bottom-feat-card d-flex align-items-center gap-3">
            ...
            <div>
              <h6 class="hero-bottom-feat-title mb-0">24/7 Live Support</h6>
              <small class="hero-bottom-feat-desc">Real-time GPS tracking &amp; helpline</small>
            </div>
          </div>
        </div>
