      ...
      <div class="d-flex align-items-center justify-content-between top-bar-inner">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3 top-bar-left py-1 flex-grow-1">
          ...
          <span class="top-info-pill d-none d-md-inline-flex align-items-center gap-1 text-white">
            <i class="bi bi-geo-alt-fill text-gold"></i> <span><?= !empty($addressRegion) ? $addressRegion : 'Delhi' ?>, India</span>
          </span>
        ...
        <div class="top-bar-gold-badge d-none d-lg-flex align-items-center gap-1">
          <i class="bi bi-star-fill text-dark fs-13"></i> <span>Since <?= !empty($startYear) ? $startYear : '2007' ?></span>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="col-12 col-lg-3 col-xl-3 d-flex flex-column justify-content-between border-end-lg pe-lg-4">
            ...
            <div class="overlay-social-wrap pt-3">
              <div class="d-flex align-items-center gap-2 flex-wrap">
                ...
                <a href="#" class="overlay-social-icon social-facebook" aria-label="Facebook">
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href="#" class="overlay-social-icon social-twitter" aria-label="Twitter">
                ...
                <a href="#" class="overlay-social-icon social-pinterest" aria-label="Pinterest">
                ...
                <a href="#" class="overlay-social-icon social-linkedin" aria-label="LinkedIn">
                ...
                <a href="#" class="overlay-social-icon social-instagram" aria-label="Instagram">
