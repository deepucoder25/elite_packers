    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="contact-form-header">
                <div class="d-flex align-items-center justify-content-between w-100 relative-z">
                    <span class="modal-header-title">
                        <i class="bi bi-shield-check text-gold me-2"></i> Get a Free Quote
                    </span>
                ...
                <div class="modal-header-wave">
                    <svg viewBox="0 0 500 24" preserveAspectRatio="none">
                        <path d="M0,0 C150,22 350,0 500,18 L500,24 L0,24 Z" fill="#ffffff"></path>
                    </svg>
                </div>
            </div>
            ...
            <form id="quotemodal" class="ajax-form" data-url="<?php echo site_url('contacts/booking') ?>" data-result="resultquotemodal" onsubmit="return false;">
                ...
                <div class="form-group">
                    <div class="form-icon">
                        ...
                        <textarea name="message" cols="30" rows="4" class="form-control" placeholder="Describe your relocation needs..."></textarea>
                    </div>
                </div>
                
                <div class="d-flex justify-content-center mt-3 contact-quote-gap">
                    <button id="submitbquotemodal" type="submit" class="theme-btn">Get My Free Quote <i class="bi bi-send-fill ms-1"></i></button>
                    <button onclick="document.getElementById('resultquotemodal').innerHTML = '';" type="reset" class="theme-btn btn-reset">Clear Form</button>
                </div>
